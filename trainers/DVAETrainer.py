...
class DVAETrainer(Trainer):
    r"""
        train teacher using DVAE method
    """
    def __init__(self,
                 args,
        ...
        self.model_list = model_list # 0: main teacher, 1: auxiliary teacher, 2: prior model
        self.tag_list = tag_list # 0: main teacher, 1: auxiliary teacher, 2: prior model
        ...
        self.loss_fct = DVAELoss(self.prior_model, self.auxiliary_model, args)
    ...
    def _create_log_data(self, metrics: dict = None):
        data_dict = {
            ...
            self.tag_list[2]: self.prior_model.state_dict(),
